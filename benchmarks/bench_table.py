...
class TableBenchmarkSuite:
        ...
        for nrows in self.table_sizes:
            for config in self.column_configs:
                ...
                if TableBenchmarkData.write_table_fits(data, filename):
                    self._bench_table_read_operations(
    ...
    def _bench_table_read_operations(self, filename, label):
    ...
    def run_all_benchmarks(self):
        ...
        self.bench_table_reading()
        self.bench_table_operations()
        self.bench_column_access()
        self.bench_streaming()
        self.print_summary()

...
class GPUMemoryBenchmark:
    ...
    def bench_direct_gpu_loading(self):
    ...
    def bench_gpu_memory_efficiency(self):
    ...
    def run_comprehensive_benchmark(self):
        ...
        self.bench_gpu_memory_efficiency()

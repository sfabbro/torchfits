...
class TransformBenchmark:
        ...
        for size in self.test_sizes:
            ...
            for transform_name, transform in self.transform_configs.items():
                ...
                if times and times[0] != float("inf"):
                    ...
                    print(
                        f"    {transform_name:15s}: {avg_time * 1000:.2f}ms, {(size[0] * size[1] / 1e6) / avg_time:.2f} Mpixels/s"
                    )
    ...
    def generate_plots(self, results: Dict[str, Any]):
        ...
        ax1.set_ylabel("Throughput (Mpixels/s)")
    ...
    def save_results(self, results: Dict[str, Any]):
        ...
        if csv_data:
            ...
            csv_path = self.output_dir / "transform_bench_results.csv"

...
_ROOT_FUNCTIONS: dict[str, tuple[str, str]] = {
    ...
    "_invalidate_path_caches": ("torchfits.io", "_invalidate_path_caches"),
    "replace_hdu": ("torchfits.io", "replace_hdu"),
    "delete_hdu": ("torchfits.io", "delete_hdu"),
    "_normalize_cpp_table_data": ("torchfits.io", "_normalize_cpp_table_data"),
    "write_checksums": ("torchfits.io", "write_checksums"),
    "_write_header_cards_if_supported": ("torchfits.io", "_write_header_cards_if_supported"),

...
class LegacyPolynomial:
    ...
    def evaluate(self, x: Tensor, y: Tensor) -> Tensor:
        ...
        # 1. Normalize
        # bounds: x_min, x_max
        nx = (2.0 * x - (self.x_bounds[1] + self.x_bounds[0])) / (self.x_bounds[1] - self.x_bounds[0])
        ny = (2.0 * y - (self.y_bounds[1] + self.y_bounds[0])) / (self.y_bounds[1] - self.y_bounds[0])
...
def project_tnx(xi: Tensor, eta: Tensor, params: Optional[Dict[str, float]] = None, wat_data: Optional[Dict[int, str]] = None) -> Tuple[Tensor, Tensor]:
    """
    TNX Projection.
...
def project_zpx(xi: Tensor, eta: Tensor, params: Optional[Dict[str, float]] = None, wat_data: Optional[Dict[int, str]] = None) -> Tuple[Tensor, Tensor]:
    """

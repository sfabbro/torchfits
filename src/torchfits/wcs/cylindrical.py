...
def project_cylindrical(xi: Tensor, eta: Tensor, projection_code: str, params: Optional[Dict[str, float]] = None) -> Tuple[Tensor, Tensor]:
    """
    ...
    if projection_code == 'CEA':
        ...
        raise NotImplementedError(f"Cylindrical code {projection_code} not implemented.")

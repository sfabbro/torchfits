...
class TestTableReading:
    ...
    def test_basic_table_reading(self):
        ...
        try:
            result, header = torchfits.read(filepath, hdu=1)  # Tables are usually in HDU 1
    ...
    def test_large_table_streaming(self):
        ...
        try:
            ...
            result = torchfits.read_large_table(filepath, max_memory_mb=1, streaming=True)
...
class TestTablePerformance:
    ...
    def test_chunked_reading_performance(self):
        ...
        try:
            ...
            result = torchfits.read_large_table(filepath, max_memory_mb=10, streaming=True)

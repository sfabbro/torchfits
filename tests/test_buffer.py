...
from torchfits.buffer import (
    ...
    optimize_for_workload, create_streaming_buffer, get_optimal_buffer_config
)
...
class TestBufferManager:
    ...
    def test_buffer_manager_creation(self):
        ...
        manager = BufferManager(buffer_size_mb=128, num_buffers=4, enable_memory_pool=True)
    ...
    def test_create_streaming_buffer(self):
        ...
        stream_buf = manager.create_streaming_buffer("stream1", 5, (3, 3), torch.float32)
    ...
    def test_get_memory_usage(self):
        ...
        required_keys = [
            'num_buffers', 'num_streaming_buffers', 'buffer_size_mb',
            'num_buffers_config', 'memory_pool_enabled', 'total_memory_mb',
            'available_memory_mb'
        ]
...
class TestGlobalFunctions:
    ...
    def test_get_optimal_buffer_config(self, mock_memory):
        ...
        required_keys = [
            ...
            'streaming_buffer_capacity', 'total_memory_mb', 'memory_utilization'
        ]
...
class TestBufferPerformance:
    ...
    def test_streaming_buffer_performance(self):
        ...
        buffer = StreamingBuffer(capacity=1000, item_shape=(50, 50), dtype=torch.float32)

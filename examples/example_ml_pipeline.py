...
from torchfits.transforms import (
    ZScale, RandomCrop, RandomFlip, GaussianNoise, Compose,
    create_training_transform, create_validation_transform
)
...
def demo_dataset_creation():
    ...
    try:
        ...
        val_dataset = LabeledFITSDataset(
            val_files, val_labels, transform=val_transform
        )
...
def main():
    ...
    try:
        ...
        if train_dataset is not None and val_dataset is not None:
            # DataLoader creation
            train_loader, val_loader = demo_dataloader_creation(train_dataset, val_dataset)
            print()

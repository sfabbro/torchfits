...
| [`example_ml_training_loop.py`](published-examples/example_ml_training_loop.py) | Raw FITS to a training step: band discovery, DQ masks, data-state contract, spectra/IFU/catalog loaders |
